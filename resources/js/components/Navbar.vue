    ...
    <nav class="w-full py-5">
        <div class="container mx-auto">
            <ul class="flex justify-between align-middle">
                ...
                <li class="flex justify-center align-middle relative hidden sm:block mr-5" v-if="user">
                    <button class="bg-transparent border-0 flex flex-no-wrap justify-center align-middle rounded-lg hover:bg-gray-700 px-4 py-2" @click="toggleDropdown" style="width: 350px">
                        ...
                        <div class="flex flex-col my-auto">
                            ...
                            <span class="text-gray-600 text-xs text-left">
                                {{user.handle}}
                            </span>
                        </div>
                        <i class="my-auto ml-3 text-white my-auto" style="width: 30px; height: 30px; stroke-width: 1" data-feather="chevron-down"></i>
                    </button>
                    <div class="dropdown bg-gray-700 border-gray-700 rounded-lg flex flex-no-wrap flex-col py-4 transition ease-in-out duration-100 z-40" v-if="dropdownExpanded">
                ...
                <li class="flex justify-center align-middle relative block sm:hidden" v-if="user">
                    <button class="bg-transparent border-0 flex flex-no-wrap justify-center align-middle rounded-lg hover:bg-gray-700 px-4 py-2 mr-5" @click="toggleDropdown">
                        <i class="my-auto text-white" style="width: 30px; height: 30px; stroke-width: 1" data-feather="menu"></i>
                    </button>
                    <div class="dropdown-sm bg-gray-700 border-gray-700 rounded-lg flex flex-no-wrap flex-col py-4 mx-auto transition ease-in-out duration-100 z-40" v-if="dropdownExpanded">
                        <div class="flex justify-center align-middle overflow-hidden">
                            <div class="w-16 h-16 rounded-full bg-indigo-900 mx-2 overflow-hidden flex" style="min-height: 4rem; min-width: 4rem;">
                                <img class="w-full h-auto object-cover" :src="user.avatar" alt="Profile image">
                            </div>
                            <div class="flex flex-col my-auto">
