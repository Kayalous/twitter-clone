    ...
    <div class="container mx-auto">
        <div class="flex flex-wrap justify-center">
            <div class="w-full max-w-sm">
                <div class="flex flex-col break-words border border-2 border-gray-900 rounded shadow-md">

                    <div class="font-semibold text-center text-2xl bg-gray-900 text-gray-100 py-3 px-6 mb-0">
                        {{ __('Register') }}
                    </div>
                    ...
                    <form class="w-full p-6" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="flex flex-wrap mb-6">
                            <label for="password-confirm" class="block text-gray-100 text-sm font-bold mb-2">
                                {{ __('Confirm Password') }}:
                            </label>
                        ...
                        <div class="flex flex-wrap">
                            <button type="submit" class="inline-block align-middle text-center select-none font-bold whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline text-gray-100 bg-blue-500 hover:bg-blue-700 mx-auto">
                                {{ __('Register') }}
                            </button>

                            <p class="w-full text-xs text-center text-gray-100 mt-8 -mb-4">
