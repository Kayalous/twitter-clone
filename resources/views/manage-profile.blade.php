                ...
                <form class="bg-gray-900 bg-opacity-75 shadow-md rounded px-8 pt-6 pb-8 mb-4 flex-grow" method="POST" enctype='multipart/form-data' style="max-width: 500px">
                    <div class="mb-4">
                        <label class="block text-gray-200 text-sm font-bold mb-2 rounded-full" for="avatar">
                            <div class="h-32 w-32 md:h-48 md:w-48 lg:h-64 lg:w-64 mx-auto my-5 rounded-full bg-indigo-900 overflow-hidden border-2 border-white border-opacity-50 relative">
                                <img class="w-full h-auto" src="{{Auth::user()->avatar}}" alt="Profile image" id="img-preview">
